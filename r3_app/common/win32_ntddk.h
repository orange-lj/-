...
// SEDE {
typedef BOOL(*P_CreateHardLinkW)(LPCWSTR lpFileName, LPCWSTR lpExistingFileName, LPSECURITY_ATTRIBUTES lpSecurityAttributes);
typedef DWORD(*P_GetCurrentDirectoryW)(DWORD nBufferLength, LPWSTR lpBuffer);
typedef struct _RTL_RELATIVE_NAME {
    UNICODE_STRING RelativeName;
    HANDLE ContainerDirectory;
    void* CurDirRef;
} RTL_RELATIVE_NAME, * PRTL_RELATIVE_NAME;
typedef NTSTATUS(*P_RtlDosPathNameToRelativeNtPathName_U_WithStatus)(WCHAR* DosPath, UNICODE_STRING* NtPath, WCHAR** FilePart, RTL_RELATIVE_NAME* Relative);
...
typedef DWORD(*P_GetFileVersionInfoSizeW)(
    LPCWSTR lptstrFilename,
    LPDWORD lpdwHandle);

typedef BOOL(*P_GetFileVersionInfoW)(
    LPCWSTR lptstrFilename,
    DWORD dwHandle,
    DWORD dwLen,
    LPVOID lpData);

typedef BOOL(*P_VerQueryValueW)(
    LPCVOID pBlock,
    LPCWSTR lpSubBlock,
    LPVOID* lplpBuffer,
    PUINT puLen);
